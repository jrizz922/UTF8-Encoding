...
#   those that are not - this is unusual, but \index is not normally
...
def SubjectIndexEntries(Paper, IgnoreThese=None, TexFileName=""):
    ...
    if not os.path.exists(TexFileName):
        ...
        #  because of the commencing aspects of these entries, they really
        #  do have to be on separate lines, and \index only takes one
